...
<?php if ($informacionObjeto[1]!=3 && $informacionObjeto[1]!=4 && $informacionFuncionario[0][fisicamenteEstructura]!=23 && $informacionFuncionario[0][fisicamenteEstructura]!=20 && $informacionFuncionario[0][fisicamenteEstructura]!=16): ?>
